...
import { SessionRagIndicator } from "@/components/session-rag-indicator"
      ...
      <div class="px-4 flex items-center justify-between gap-4 w-full">
        <div class="flex items-center gap-3 min-w-0">
            ...
            >
              <div class="flex items-center gap-2 min-w-0">
                <Select
                  ...
                  placeholder="Voltar para sessão pai"
                  label={(x) => x.title}
                  value={(x) => x.id}
                  onSelect={(session) => {
                ...
                <div class="flex items-center gap-1.5 min-w-0">
                    <Tooltip value="Voltar para sessão pai">
                    <button
                      type="button"
          ...
          <Show when={currentSession() && !parentSession()}>
            <TooltipKeybind class="hidden xl:block" title="Nova sessão" keybind={command.keybind("session.new")}>
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center gap-1">
            ...
            <Show when={auth.hasPermission("canAccessTerminal") && auth.isDeveloperMode()}>
              <TooltipKeybind
                class="hidden md:block shrink-0"
          ...
          <Show when={shareEnabled() && currentSession() && auth.hasPermission("canShareSessions")}>
            <Popover
              title="Compartilhar sessão"
              trigger={
                <Tooltip class="shrink-0" value="Compartilhar sessão">
